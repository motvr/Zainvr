...
GAME_MESSAGE = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ VR⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب فير\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ VR⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('VR', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ѕᴏụʀᴄᴇ VR⌝⚡️', url =f"https://t.me/Jaithon")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ VR⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب فير 3D\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ VR⌝━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ VR⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب فير\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ VR⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب فير', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ѕᴏụʀᴄᴇ VR⌝⚡️', url =f"https://t.me/Jaithon")              
                 ],[
                InlineKeyboardButton(
