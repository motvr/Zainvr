...
async def get_thumb(videoid):
    ...
    font = ImageFont.truetype("AarohiX/assets/assets/font2.ttf", 30)
    title_font = ImageFont.truetype("AarohiX/assets/assets/font2.ttf", 45)
    ...
    draw.text((text_x_position, 260), f"VR PLAYING", (255, 255, 255), font=arial)
